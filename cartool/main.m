...
{
	NSError *error = nil;
//    outputDirectoryPath = [outputDirectoryPath stringByStandardizingPath];
//    NSLog(@"11:%@",outputDirectoryPath);
	outputDirectoryPath = [outputDirectoryPath stringByExpandingTildeInPath];
    NSLog(@"21:%@",outputDirectoryPath);
//    return;
...
int main(int argc, const char * argv[])
{
	@autoreleasepool {
        ...
        NSLog(@"argc:%d   %@",argc, [NSString stringWithUTF8String:argv[0]]);
        system("echo  `pwd`");
